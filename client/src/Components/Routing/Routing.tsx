...
import EmailCheck from "../HomeArea/RecoverPassword/EmailCheck/EmailCheck";
import RestartPassword from "../HomeArea/RecoverPassword/RestartPassword/RestartPassword";
    ...
    return (
        <div className="Routing">
            <Routes>
                ...
                <Route path="email-validation-password" element={<EmailCheck />}/>
